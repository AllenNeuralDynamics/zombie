from zombie.core.docdb import get_subjects, get_sessions
import pandas as pd
...
subject_selector = pn.widgets.MultiSelect(
    name="Subjects", options=get_subjects()
)
...
def update_chart(selected_subjects):
    ...
    df_sessions = pd.DataFrame(
        session_data, columns=["subject", "start_date", "end_date"]
    )
    ...
    bottom_chart = (
        ...
        .mark_bar()
        .encode(
            x="start_date:T", x2="end_date:T", y="subject:N", color="subject:N"
        )
